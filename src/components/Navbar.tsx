            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center space-x-2 bg-gradient-to-r from-red-500 to-red-600 text-white px-6 py-2.5 rounded-full font-semibold shadow-lg hover:from-red-600 hover:to-red-700 transition-all duration-300 transform hover:scale-105"
                >
                  <LogOut size={20} />
                  <span>Logout</span>
                </button>
            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center space-x-2 bg-gradient-to-r from-red-500 to-red-600 text-white px-6 py-2.5 rounded-full font-semibold shadow-lg hover:from-red-600 hover:to-red-700 transition-all duration-300"
                >
                  <LogOut size={20} />
                  <span>Logout</span>
                </button>
              ...
              <>
                <Link 
                  to="/login" 
                  className="flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-2.5 rounded-full font-semibold shadow-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300"
                  onClick={() => setIsOpen(false)}
                >
                  <LogIn size={20} />
                  <span>Login</span>
